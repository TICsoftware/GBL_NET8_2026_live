...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        string connstrlive = "user id=sa;data source=Priyacement\\SQLEXPRESS;persist security info=True;initial catalog=GBL_2026;password=T!5h0@A7i4rD;Encrypt=True;TrustServerCertificate=True";
