    ...
    public class Industry_Category_Master_DAL : DBHelper
    {
        ...
        public int Insert(Industry_Category_Master_Entity m)
        {
            SqlParameter[] p =
            {
                ...
                new("@Landing_Thumbnail_Image_Alt", (object?)m.Landing_Thumbnail_Image_Alt ?? DBNull.Value),
                new("@Window_Title", (object?)m.Window_Title ?? DBNull.Value),
                new("@Meta_Title", (object?)m.Meta_Title ?? DBNull.Value),
                new("@Meta_Description", (object?)m.Meta_Description ?? DBNull.Value),
        ...
        private static Industry_Category_Master_Entity MapRow(DataRow r, string type)
        {
            return new Industry_Category_Master_Entity
            {
                ...
                Landing_Thumbnail_Image_Alt = ColStr(r, "Landing_Thumbnail_Image_Alt"),
                Window_Title = ColStr(r, "Window_Title"),
                Meta_Title = ColStr(r, "Meta_Title"),
                Meta_Description = ColStr(r, "Meta_Description"),
